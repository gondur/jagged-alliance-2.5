...
#define MSS_VERSION      "5.0e"
#define MSS_VERSION_DATE "1-Jan-99"
...
#define DEFAULT_DDFS               50     // Use 50 millisecond buffer fragments with DirectSound if MSS mixer in use

#define DIG_DS_FRAGMENT_CNT        35
#define DEFAULT_DDFC               2      // Use 2 buffer fragments with DirectSound if MSS mixer in use
...
#define N_PREFS 41                      // # of preference types
...
typedef S32        (AILCALL FAR * M3D_3D_SET_SAMPLE_PREFERENCE)(H3DSAMPLE samp, HATTRIB preference, S32 value);
...
typedef void       (AILCALL FAR * M3D_3D_SAMPLE_DISTANCES)(H3DSAMPLE samp,
                                                           U32 FAR * max_front_dist,
                                                           U32 FAR * min_front_dist,
                                                           U32 FAR * max_back_dist,
                                                           U32 FAR * min_back_dist);
...
typedef enum
{
   DP_ASI_DECODER,   // Must be "ASI codec stream" provider
   DP_POST_DECODER,  // Must be "MSS pipeline filter" provider
...
typedef enum
{
   ...
   DP_POST_COPY,     // Must be "MSS pipeline filter" provider
