...
void AddAllEmails()
{
	...
	AddEmail( EMAIL_CONCERNED, EMAIL_CONCERNED_LENGTH, MAIL_ENRICO,  GetWorldTotalMin() );
	AddEmail( EMAIL_URGENT, EMAIL_URGENT_LENGTH, MAIL_ENRICO,  GetWorldTotalMin() );
	...
	AddEmail( EMAIL_EXTRACASH, EMAIL_EXTRACASH_LENGTH, MAIL_ENRICO,  GetWorldTotalMin() );
